...
public class DemoNoSQLTablePantry extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTablePantry.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKeyAndSortKey extends DemoNoSQLOperationBase {
        ...
        DemoGetWithPartitionKeyAndSortKey(final Context context) {
            super(context.getString(R.string.nosql_operation_get_by_partition_and_sort_text),
                String.format(context.getString(R.string.nosql_operation_example_get_by_partition_and_sort_text),
                    ...
                    "Expiry", "demo-userId-500000"));
        }

        @Override
        public boolean executeOperation() {
            // Retrieve an item by passing the partition key using the object mapper.
            result = mapper.load(PantryDO.class, AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID(), "demo-Expiry-500000");
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLPantryResult(result));
    ...
    public class DemoQueryWithPartitionKeyAndSortKeyCondition extends DemoNoSQLOperationBase {
        ...
        private PaginatedQueryList<PantryDO> results;
        private Iterator<PantryDO> resultsIterator;
        ...
        @Override
        public boolean executeOperation() {
            final PantryDO itemToFind = new PantryDO();
            itemToFind.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());

            final Condition rangeKeyCondition = new Condition()
                .withComparisonOperator(ComparisonOperator.LT.toString())
                .withAttributeValueList(new AttributeValue().withS("demo-Expiry-500000"));
            final DynamoDBQueryExpression<PantryDO> queryExpression = new DynamoDBQueryExpression<PantryDO>()
                .withHashKeyValues(itemToFind)
                .withRangeKeyCondition("Expiry", rangeKeyCondition)
                .withConsistentRead(false)
                .withLimit(RESULTS_PER_RESULT_GROUP);

            results = mapper.query(PantryDO.class, queryExpression);
            if (results != null) {
    ...
    public class DemoQueryWithPartitionKeyAndFilter extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() {
            ...
            filterExpressionAttributeNames.put("#ID", "ID");

            final Map<String, AttributeValue> filterExpressionAttributeValues = new HashMap<>();
            filterExpressionAttributeValues.put(":MinID",
                new AttributeValue().withN("1111500000"));

            final DynamoDBQueryExpression<PantryDO> queryExpression = new DynamoDBQueryExpression<PantryDO>()
                .withHashKeyValues(itemToFind)
                .withFilterExpression("#ID > :MinID")
    ...
    public class DemoScanWithFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<PantryDO> results;
        private Iterator<PantryDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            results = mapper.scan(PantryDO.class, scanExpression);
            if (results != null) {
                resultsIterator = results.iterator();
                if (resultsIterator.hasNext()) {
                    return true;
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<PantryDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final PantryDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLPantryResult(item));
            itemsRetrieved++;
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final PantryDO firstItem = new PantryDO();

        firstItem.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());
        firstItem.setExpiry("demo-Expiry-500000");
        firstItem.setID(DemoSampleDataGenerator.getRandomSampleNumber());
        firstItem.setName(
            DemoSampleDataGenerator.getRandomSampleString("Name"));
        firstItem.setQuantity(
            DemoSampleDataGenerator.getRandomSampleString("Quantity"));
        firstItem.setType(
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        final PaginatedQueryList<PantryDO> results = mapper.query(PantryDO.class, queryExpression);

        Iterator<PantryDO> resultsIterator = results.iterator();
        ...
        final List<PantryDO> batchOfItems = new LinkedList<PantryDO>();
